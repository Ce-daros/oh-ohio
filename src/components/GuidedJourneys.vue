...
import { getContent, type WorldId } from "../content";
...
const portraits = { explore:'discover', make:'economy', culture:'language', live:'government' } as const;
...
<template>
  <section :class="['guided-journeys',`journeys-${chapterId}`]" aria-labelledby="journey-heading">
    <header class="journeys-header"><div><p class="eyebrow">A READING JOURNEY</p><h2 id="journey-heading">One story leads<br />to <em>another.</em></h2></div><CharacterArt :chapter="portraits[chapterId]" alt="Ohio-chan with a few reading suggestions" sizes="180px" /></header>
